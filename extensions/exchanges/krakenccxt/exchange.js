...
module.exports = function kraken (conf) {
  ...
  var exchange = {
    ...
    getTrades: function (opts, cb) {
      ...
      if (firstRun) {
        client.fetchOHLCV(joinProduct(opts.product_id), '2h', args.since, undefined).then(result => {
          var lastVal = 0
        ...
        client.fetchTrades(joinProduct(opts.product_id), args.since, undefined).then(result => {
